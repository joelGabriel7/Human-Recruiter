        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/erp/vacante/apply/' + row.id + '/" type="button" target="_blank"  data-toggle="modal" data-target="#ModalShareForm" rel="apply" class="btn btn-primary btn-xs btn-flat "><i class="fas fa-circle-check"></i></a>';
